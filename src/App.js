...
class App extends Component {
  ...
  handleAddContact = (contact) => {
    ...
    this.setState(({ contacts }) => ({ contacts: [ ...contacts, contact ] }), this.storeContacts);
  };
  ...
  getContacts() {
    if (this.state.filter) {
      ...
      return store.getState().contactForm.contacts;
    }
  }

  storeContacts() {
    localStorage.setItem(this.LOCAL_STORAGE_KEY, JSON.stringify(this.state.contacts));
  }
